                    ...
                    @foreach ($bozps as $category)
                        <div class="col-2 col-sm-2 col-md-2 col-xl-2 col-xxl-2 ps-0 m-0">
                            <a class="btn bg-{{ $category->color }}-lt hover-shadow-sm w-100 m-1" data-bs-toggle="tooltip"
                                ...
                                data-bs-original-title="{{ __('BOZP a PO - ' . $category->category_name) }}"
                                href="/bozp/{{ $category->folder_name . '/' . $category->id }}">
                                <span
                                    class="d-inline d-sm-inline d-md-none d-lg-inline d-xl-inline">{!! $category->svg_icon !!}</span>
                                <span
                                    class="d-none d-md-inline d-lg-inline d-xl-inline pe-1">{{ $category->category_name }}</span>
                                ...
                                <div id="test-{{ $document->position }}">
                                    <div class="accordion-body p-1">
                                            ...
                                            <div class="list-group-item border-0 p-0">
                                                <div class="row align-items-center g-3 mx-2">
                                                    <div class="avatar bg-{{ $document->category->color }}-lt col-auto"
                                                        ...
                                                        <a
                                                            href="/bozp/{{ $document->category->folder_name }}/{{ $document->category->id }}">
                                                    ...
                                                    <div class="col-auto">
                                                        <a href="{{ route('soubory.bozp.download', $document->id) }}"
                                                            target="_blank">
                                                            <span class="avatar bg-{{ $document->category->color }}-lt"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                data-bs-original-title="Stáhnout dokument">
                                                                <img src="{{ asset('img/files/pdf.png') }}"
                                                                    alt="PDF soubor" height="32px">
                                                            </span>
                                                        </a>
                                                    </div>
                                                    <div class="col text-truncate" id="{{ $document->id }}">
                                                        <span>
                                                            <p class="show d-inline text-primary text-decoration-none cursor-pointer"
                                                                id="{{ $document->id }}" data-bs-toggle="tooltip"
                                                                data-bs-placement="top"
                                                    ...
                                                    @auth
                                                        <div class="col-auto">
                                                            <span class="btn btn-icon hover-shadow cursor-pointer"
                                                                ...
                                                                <svg class="icon dropdown-item-icon" width="24"
                                                ...
                                                <div class="row d-flex justify-content-between">
                                                    <div class="col-auto">
                                                        @if (Carbon\Carbon::parse($document->created_at)->addDays(1) >= Carbon\Carbon::today())
                                                            <span
                                                                class="badge badge-sm bg-red-lt text-uppercase ms-auto">Nový
                                                                !</span>
                                                        @endif
                                                        @if (Carbon\Carbon::parse($document->updated_at)->addDays(7) >= Carbon\Carbon::now())
                                                            <span
                                                                class="badge badge-sm bg-lime-lt text-uppercase ms-auto">Aktualizováno
                                                                !</span>
                                                        @endif
                                                        <span
                                                        ...
                                                        <svg class="icon text-yellow" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <line x1="6" y1="9" x2="18"
                                                                y2="9"></line>
                                                            <line x1="6" y1="12" x2="9"
                                                                y2="12"></line>
                                                            <line x1="6" y1="15" x2="8"
                                                                y2="15"></line>
                                                        </svg>
                                                        ...
                                                        @auth
                                                            ...
                                                            @else
                                                                <span
                                                                    class="badge badge-sm bg-green-lt text-uppercase ms-auto">Schváleno</span>
                                                            @endif
                                                        @endauth
                                                    </div>
                                                    @auth
                                                        <div class="d-xs-none d-sm-none d-lg-inline col-auto">
                                                            <span class="text-muted description">
                                                                <svg class="icon text-lime" xmlns="http://www.w3.org/2000/svg"
                                                                    width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        @foreach ($document->addons as $add)
                                            <div class="row align-items-center g-3 mx-2">
                                                <div class="avatar bg-{{ $document->category->color }}-lt col-auto">
                                                    <div class="text-uppercase" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                    ...
                                                    <a href="{{ route('soubory.bozp.addon.download', $add->id) }}">
                                                        <span class="avatar bg-{{ $document->category->color }}-lt"
                                                            ...
                                                            <img src="{{ asset('img/files/pdf-add.png') }}"
                                                                alt="PDF - Příloha standardu" height="32px">
                                                        </span>
                                                    </a>
                                                </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 col-lg-2 mb-2">
                                    ...
                                    <input class="form-control" id="next_revision_date" name="next_revision_date"
                                        type="date" placeholder="{{ __('Next revision Date') }}">
                                </div>
                                <div class="col-9 col-lg-10 mb-2">
                                    <label class="form-label">{{ __('Popis dokumentu') }} <small
                                            class="text-azure">usnadní
                                            vyhledávání</small></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-8 mb-2">
                                    <label class="form-label">{{ __('Oblast působnosti dokumentu') }} <small
                                            class="text-azure">usnadní
                                            vyhledávání</small></label>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="align-content-end flex">
                                <button class="btn btn-primary ms-auto hover-shadow" id="action_button"
                                    name="action_button" type="submit">
                                    <svg class="icon icon-tabler icon-tabler-book-upload"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <div class="modal fade" id="addonShowModal" role="dialog" aria-hidden="true" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered modal-full-width" role="document">
              ...
              <div class="row mt-3">
                    ...
                    <div class="modal-footer">
                        <div class="align-content-end flex">
                            <a class="btn btn-red ms-auto hover-shadow" id="addon-download-btn" type="button"
                                href="">
                                <svg class="icon icon-inline" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
