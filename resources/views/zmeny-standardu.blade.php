            ...
            <div class="list-group-item border-0 p-0">
              <div class="row align-items-center g-3 mx-2">
                <div class="avatar bg-{{ $document->category->color }}-lt col-auto" data-bs-toggle="tooltip" data-bs-placement="top"
                     data-bs-original-title="{{ $document->category->folder_name }} standardy">
        ...
        $(document).on('click', '.show', function() {
          ...
          $.ajax({
            ...
            success: function(html) {
              ...
              $('#show-modal-icon').html(html.data.category.svg_icon).addClass('bg-'+ html.data.category.color +'-lt')
              ...
              $('#show-folder_name').Zavedení periferního žilního katétru (PŽK)
