                  ...
                  <div class="list-group-item border-0 p-0">
                    <div class="row align-items-center g-3 mx-2">
                      ...
                      <div class="col text-truncate" id="{{ $standard->id }}">
                        <span>
                          <p class="show d-inline text-primary text-decoration-none cursor-pointer" id="{{ $standard->id }}" data-bs-toggle="tooltip"
                             data-bs-placement="top" data-bs-original-title="Více informací o standardu {{ $standard->description }}" style="margin-bottom: 0;">
                            @if($standard->category_id <> 3)
                              {{ $standard->position }}.
                              @endif {{ $standard->name }}</p>
                        </span>
                      ...
                      <div class="col-auto">
                        ...
                        <ul class="dropdown-menu">
                          <li class="dropdown-item edit" id="{{ $standard->id }}">
                            <svg class="icon dropdown-item-icon-edit" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                 fill="none" stroke-linecap="round" stroke-linejoin="round">
                              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                              <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" />
                          ...
                          <li class="dropdown-item delete" id="{{ $standard->id }}'">
                            <svg class="icon icon dropdown-item-icon-delete" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                              <path d="M4 7h16"></path>
        ...
        $(document).on('click', '.edit', function() {
          ...
          $.ajax({
            ...
            success: function(html) {
              ...
              PDFObject.embed("../../soubory/" + html.data.file +"#toolbar=0", "#pdf-preview", {height: "31rem"})
            }
          })
        });
        ...
        $(document).on('click', '.show', function() {
          ...
          $.ajax({
            ...
            success: function(html) {
              ...
              PDFObject.embed("../../soubory/" + html.data.file +"#toolbar=0", "#pdf-preview-show", {height: "33rem"})
            }
          })
        });
        ...
        $(document).on('click', '.show-addon', function() {
          ...
          $.ajax({
            ...
            success: function(html) {
              ...
              PDFObject.embed("../../soubory/" + html.data.file + "#toolbar=0", "#pdf-preview-addon-show", {height: "30rem"})
            }
          })
        });
