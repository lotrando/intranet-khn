...
<html>
    ...
    <style>
      ...
      *,
      ...
      .dropdown-item:hover {
        color: inherit;
        text-decoration: none;
        background-color: rgba(98, 105, 118, .06)
      }
      ...
      .offcanvas-start {
        ...
        left: 0;
        width: 400px;
        border-right: 1px solid rgba(98, 105, 118, .16);
        transform: translateX(-100%)
      }
  ...
  */
      ...
      .border-0 .card-stacked::after {
        border: 1px solid rgba(98, 105, 118, .07) !important
      }
      ...
      .bg-secondary-lt {
        color: #626976 !important;
        background: rgba(98, 105, 118, .1) !important
      }
      ...
      .bg-google-lt {
        color: #dc4e41 !important;
        background: rgba(220, 78, 65, .1) !important
      }
      ...
      .bg-vimeo-lt {
        color: #1ab7ea !important;
        background: rgba(26, 183, 234, .1) !important
      }
      ...
      .bg-github-lt {
        color: #181717 !important;
        background: rgba(24, 23, 23, .1) !important
      }
      ...
      .bg-pinterest-lt {
        color: #bd081c !important;
        background: rgba(189, 8, 28, .1) !important
      }
      ...
      .bg-vk-lt {
        color: #6383a8 !important;
        background: rgba(99, 131, 168, .1) !important
      }
      ...
      .bg-flickr-lt {
        color: #0063dc !important;
        background: rgba(0, 99, 220, .1) !important
      }
  ...
  <body>
    ...
    <div class="card-body">
      ...
      <div class="accordion-item bg-{{ $item->category->color }}-lt">
        <div class="accordion-body pt-2">
          <div class="list-group list-group-flush list-group-hoverable pt-1">
            <div class="list-group-item">
              <div class="row align-items-center">
                <div class="avatar bg-{{ $item->category->color }}-lt col-auto" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="#{{ $item->id }}">
                ...
                <div class="col text-truncate">
                  ...
                  <div class="d-block text-muted text-truncate">{{ $item->description }}</div>
                </div>
                <div class="col-auto">
                  ...
                  <span class="text-muted">Aktualizováno {{ Carbon\Carbon::parse($item->updated_at)->format('d. m. Y') }}</span>
                  ...
                  <span class="text-muted">Revize: {{ $item->revision }}</span>
