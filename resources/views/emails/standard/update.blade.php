            ...
            <div class="list-group list-group-flush list-group-hoverable pt-1">
              <div class="list-group-item">
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    <a href="{{ route('soubory.standard.download', $item->id) }}" target="_blank">
                  ...
                  <div class="col text-truncate">
                    <a class="text-primary d-block text-decoration-none" href="{{ route('soubory.standard.download', $item->id) }}" target="_blank">
